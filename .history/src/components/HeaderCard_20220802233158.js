    ...
    <div className={styles.container}>
        <div className={styles.wrapper}>
            <div className={styles.overlaycontainer}>
              <p className={styles.desc}>Take-Away and Deliveries</p>
        ...
        <div className={styles.wrapper}>
            <div className={styles.overlaycontainer}>
              <p className={styles.desc}>Open Restaurants</p>
              <p className={styles.path}>Through 8/26</p>
              <button className={styles.ordernow}>
                Order Now!
              </button>
            ...
            <img 
               src='https://images.unsplash.com/photo-1594221708779-94832f4320d1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Y2hpY2tlbiUyMGZvb2R8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60'
               alt="/"
               className={styles.image}
            />
        </div> 
        <div className={styles.wrapper}>
            <div className={styles.overlaycontainer}>
              <p className={styles.desc}>Paid partnership with our partners</p>
              <p className={styles.path}>Through 8/26</p>
              <button className={styles.ordernow}>
                Order Now!
              </button>
            ...
            <img 
               src='https://media.istockphoto.com/photos/serbian-buger-picture-id450810497?s=612x612'
               alt="/"
               className={styles.image}
            />
        </div>      
